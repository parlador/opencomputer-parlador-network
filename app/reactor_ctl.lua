...
for i,Reactor in pairs(Reactorlist) do
  ...
  ReactorLabel[Reactor["Address"]]={chartFuel=application:addChild(gui.chart(72, 3, 28, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xD2DE67, 1, 1, "s", "%", true, {}))}
  ...
  ReactorLabel[Reactor["Address"]]={chartReact=application:addChild(gui.chart(102, 3, 28, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0x00FF91, 1, 1, "s", "%", true, {}))}
  ...
  ReactorLabel[Reactor["Address"]]={chartPowerOuput=application:addChild(gui.chart(72, 11, 28, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xA82B2B, 1, 1, "s", "RF", true, {}))}
  ...
  --application:addChild(GUI.text(73, 20, 0xFFFFFF, "      POWER BANK            "))
  ReactorLabel[Reactor["Address"]]={chartPower=application:addChild(gui.chart(102, 11, 28, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xA82B2B, 1, 1, "s", "%", true, {}))}
