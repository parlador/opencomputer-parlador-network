...
for i,Reactor in pairs(Reactorlist) do
  ...
  ReactorLabel[Reactor["Address"]]={chartTemperature=application:addChild(gui.chart(38, 3, 33, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0x5F63FE, 1, 1, "s", "C", true, {}))}
  ...
  ReactorLabel[Reactor["Address"]]={chartFuel=application:addChild(gui.chart(71, 3, 33, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xD2DE67, 1, 1, "s", "%", true, {}))}
  ...
  ReactorLabel[Reactor["Address"]]={chartReact=application:addChild(gui.chart(104, 3, 33, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0x00FF91, 1, 1, "s", "%", true, {}))}
  ...
  --application:addChild(GUI.text(45, 20, 0xFFFFFF, "    FUEL REACTIVITE      "))
  ReactorLabel[Reactor["Address"]]={chartRod=application:addChild(gui.chart(38, 11, 33, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0x00FF91, 1, 1, "s", "%", true, {}))}
  ...
  ReactorLabel[Reactor["Address"]]={chartPowerOuput=application:addChild(gui.chart(71, 11, 33, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xA82B2B, 1, 1, "s", "RF", true, {}))}
  ...
  --application:addChild(GUI.text(73, 20, 0xFFFFFF, "      POWER BANK            "))
  ReactorLabel[Reactor["Address"]]={chartPower=application:addChild(gui.chart(104, 11, 33, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xA82B2B, 1, 1, "s", "%", true, {}))}
