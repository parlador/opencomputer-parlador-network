...
for i,Reactor in pairs(Reactorlist) do
  ...
  -- control zone
  application:addChild(gui.panel(135, GuiReactorSectionStart, 26, 5, 0x2D2D2D))
  application:addChild(gui.panel(135, GuiReactorSectionStart, 26, 1, 0x6B1F82))
  application:addChild(gui.text(136, GuiReactorSectionStart, 0x999999, "     REACTOR CONTROL    "))
  ...
  application:addChild(gui.panel(39, 1, 31, 1, 0xCE9200))
  ...
  application:addChild(gui.panel(41, 9, 31, 1, 0x1F4582))
  --application:addChild(GUI.text(45, 20, 0xFFFFFF, "    FUEL REACTIVITE      "))
  ReactorLabel[Reactor["Address"]]={chartRod=application:addChild(gui.chart(41, 10, 31, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0x00FF91, 1, 1, "s", "%", true, {}))}
  ...
  application:addChild(gui.panel(72, 9, 31, 1, 0x1F4582))
  --application:addChild(GUI.text(73, 20, 0xFFFFFF, "      POWER BANK            "))
  ReactorLabel[Reactor["Address"]]={chartPowerOuput=application:addChild(gui.chart(72, 10, 31, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xA82B2B, 1, 1, "s", "RF", true, {}))}
  ...
  application:addChild(gui.panel(103, 9, 31, 1, 0x1F4582))
  --application:addChild(GUI.text(73, 20, 0xFFFFFF, "      POWER BANK            "))
  ReactorLabel[Reactor["Address"]]={chartPower=application:addChild(gui.chart(103, 10, 31, 8, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xA82B2B, 1, 1, "s", "%", true, {}))}
