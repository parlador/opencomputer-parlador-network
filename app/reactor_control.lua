...
chartTemperature = application:addChild(GUI.chart(39, 1, 30, 10, 0xEEEEEE, 0xAAAAAA, 0x888888, 0x5F63FE, 1, 1, "s", "C", true, {}))
application:addChild(GUI.text(45, 10, 0xFFFFFF, "   FUEL TEMPERATURE       "))
table.insert(chartTemperature.values,1,{0, 0})
 
chartReact = application:addChild(GUI.chart(39, 11, 30, 10, 0xEEEEEE, 0xAAAAAA, 0x888888, 0x00FF91, 1, 1, "s", "%", true, {}))
application:addChild(GUI.text(45, 20, 0xFFFFFF, "    FUEL REACTIVITE      "))
table.insert(chartReact.values,1,{0, 0})
 
chartFuel = application:addChild(GUI.chart(70, 1, 30, 10, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xD2DE67, 1, 1, "s", "%", true, {}))
application:addChild(GUI.text(73, 10, 0xFFFFFF, "       FUEL TANK           "))
table.insert(chartFuel.values,1,{0, 0})
 
chartPower = application:addChild(GUI.chart(70, 11, 30, 10, 0xEEEEEE, 0xAAAAAA, 0x888888, 0xA82B2B, 1, 1, "s", "%", true, {}))
